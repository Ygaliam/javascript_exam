...
$(document).ready(function () {
  ...
  function judgement() {
    ...
    let pass_or_failure = '. Vous avez '+get_pass_or_failure();
    ...
    $('#declaration').append(`<label id="alert-indicate" class="alert alert-info">Votre note est  ${achievement}。${pass_or_failure}</label>`);
  };
